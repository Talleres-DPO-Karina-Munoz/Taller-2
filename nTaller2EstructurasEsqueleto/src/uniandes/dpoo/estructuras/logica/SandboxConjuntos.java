...
public class SandboxConjuntos
{
    ...
    {
    	 Collection<String> coleccionsiguientes = new ArrayList<>();
         for (String siguientes : arbolCadenas) {
             if (siguientes.compareTo(cadena) >= 0) {
            	 coleccionsiguientes.add(siguientes);
             }
         }
         return coleccionsiguientes;
    }
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	String cadenaeliminar= null;
    	for(String eliminar: arbolCadenas) {
    		if (eliminar.toLowerCase()==cadenaminuscula){
    			cadenaeliminar=eliminar;
    		}
    	}
    	if (cadenaeliminar!=null) {
    		arbolCadenas.remove(cadenaeliminar);
    	}
    }
    ...
    {
        TreeSet<String> arbolnuevo= new TreeSet<>(arbolCadenas.descendingSet());
        return arbolnuevo;
    }
